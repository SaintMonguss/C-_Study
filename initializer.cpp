...
private:
	...
	bool marriageStatus;
public:
	Human(char* name, char* sex, char* job, char* character, int age, bool marriageStatus)
	{
		std::cout << "Human :: Human() 생성자 시작" << std::endl;
		std::strcpy(this->name, name);
		std::strcpy(this->sex, sex);
		std::strcpy(this->job, job);
		//여기까지
	}
